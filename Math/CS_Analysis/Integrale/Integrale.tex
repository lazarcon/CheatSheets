...
\begin{document}
	...
	\begin{center}
	\Large{\textbf{Integralrechnung Cheat Sheet}} \\
	\end{center}
	...
	\input{Stammintegrale}

	\input{VerwendungStammfunktion}

	\input{Integrationsregeln}

	\input{Integrationsmethoden}

	\input{Flaecheninhalt}

	\input{Rotationskoerper}
