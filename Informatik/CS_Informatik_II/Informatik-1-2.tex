...
\hypersetup{
	...
	pdftitle    = {Informatik Cheat Sheet (3/4)},
...
\begin{document}
	...
	\input{FormaleSprachen}

	\input{AutomatenTheorie}

	\input{KontextfreieSprachen}

	\input{PushdownAutomaten}

	\input{TuringMaschine}

	\input{Berechenbarkeit}

	\input{Komplexitaetstheorie}
